...
public class Calendar : MonoBehaviour
{
    ...
    public class Day
    {
        ...
        public void UpdateDay(int newDayNum)
        {
            ...
            if(dayColor == Color.white || dayColor == Color.green)
            {
                ...
                UpdateButton(true);
                Calendar cal = FindObjectOfType<Calendar>();
                obj.GetComponent<DayInfo>().SetInfo((dayNum + 1), cal.tempDateTime);
            }
            else
            {
        ...
        public void UpdateButton(bool interactableDay)
        {
            obj.GetComponent<Button>().interactable = interactableDay;
        }
    }
    ...
    {
        tempDateTime = new DateTime(year, month, 1);
        currDate = tempDateTime;
        MonthAndYear.text = tempDateTime.ToString("MMMM") + " " + tempDateTime.Year.ToString();
        ...
        {
            days[(DateTime.Now.Day - 1) + startDay].UpdateColor(currentDayColor);
        }
